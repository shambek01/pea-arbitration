...
window.translations = {
    'ru': {
        ...
        'form_title': 'Подача заявки', 'form_desc': 'Заполните форму для начала процесса.',
        'label_name': 'ФИО / Организация', 'label_phone': 'Телефон', 'label_email': 'E-mail', 'label_sum': 'Сумма иска', 'label_message': 'Суть спора',
        'btn_submit_form': 'Отправить заявку', 'success_title': 'Заявка принята', 'success_desc': 'Данные сохранены в системе.',
        ...
        'how_works_desc': 'Простой процесс разрешения спора от подачи заявки до результата',
    ...
    'kz': {
        ...
        'clause_text': 'Осы шарттан (келiсiмнен, келiсiм-шарттан) не соған байланысты туындаған барлық даулар, келiспеушiлiктер немесе талаптар тұрақты жұмыс iстейтiн төрелiкте - «Орта-Азиялық экономикалық төрелiгi» ЖШС оның Регламентiне сәйкес шешiлуге тиiс. Төреліктің құрамына бір төреші кіреді. Төрелік талқылау тілі - қазақ тілі.',
        'clause_info_2': 'Жасалған шартқа (келiсiмге, келiсiм-шартқа) төрелiк ескертпенi енгiзу үшiн оған жоғарыда көрсетiлген төрелiк ескертпенi көздейтiн қосымша келiсiм жасасу қажет.',
        'doc2': 'Талап үлгісі',
        'reg_rules': 'Регламент',
        ...
        'about_a1_1': 'Төрелік - бұл нақты азаматтық-құқықтық дауды қарау үшін арнайы құрылған мемлекеттік емес сот немесе тұрақты жұмыс істейтін төрелік.',
        ...
        'about_a1_3': 'Нақты дауды қарау үшін төрелікті тараптар дауды шешу үшін құрады және осы дау шешілгенге дейін немесе тараптар дауды сотқа беру туралы шешім қабылдағанға дейін әрекет етеді.',
        'about_q2': 'Төрелікке кім жүгінуге құқылы?',
        'about_a2_1': 'Жеке және (немесе) заңды тұлғалар, олардың Қазақстан Республикасының аумағында не одан тысқары жерлерде тұратын жеріне немесе орналасқан жеріне қарамастан, төрелікте тараптар бола алады. Дау қандай да бір нақты азаматтық-құқықтық қатынас бойынша тараптар арасында туындаған немесе туындауы мүмкін дауларға қатысты тараптар арасында жасалған төрелік келісім болған кезде төреліктің қарауына берілуі мүмкін.',
        'about_a2_2': 'Сотта қарауда жатқан дауға қатысты төрелік келісім көрсетілген сот дау бойынша шешім қабылдағанға дейін жасалуы мүмкін. Бұл жағдайда сот арызды қараусыз қалдыру туралы ұйғарым шығарады.',
        'about_a2_3': 'Төрелік келісім жазбаша нысанда жасалады. Ол азаматтық-құқықтық шарттың мәтініне енгізілген төрелік ескерту түрінде жасалуы мүмкін.',
        'about_q3': 'Төрелік келісімнің нысаны мен мазмұны',
        'about_a3_1': 'Егер төрелiк келiсiм тараптар қол қойған құжатта, төрелiк ескертпе түрiнде не хаттармен, жеделхаттармен, телефонограммалармен, факстармен, электрондық құжаттармен немесе субъектiлердi және олардың ерiк бiлдiруiнiң мазмұнын айқындайтын өзге де құжаттармен алмасу жолымен жасалған болса, ол жазбаша нысанда жасалған болып есептеледi.',
        'about_a3_2': 'Төрелiк келiсiм, егер ол тараптардың бiрi келiсiмнiң бар екендiгi туралы бекiтетiн, ал екiншiсi бұған қарсылық бiлдiрмейтiн талап арыз және талап қоюға пiкiр алмасу жолымен жасалса да жазбаша нысанда жасалған болып есептеледi.',
        'about_a3_3': 'Шартта дауды төреліктің шешуіне беру туралы талапты қамтитын құжатқа сілтеме жасау шарт жазбаша нысанда жасалған жағдайда төрелік келісім болып табылады және бұл сілтеме төрелік келісімді шарттың бір бөлігіне айналдыратындай болып табылады.',
        'about_a3_info': 'Жасалған шартқа (келiсiмге, келiсiм-шартқа) төрелiк ескертпенi енгiзу үшiн оған жоғарыда көрсетiлген төрелiк ескертпенi көздейтiн қосымша келiсiм жасасу қажет.',
        'about_q4': 'Төрелік қандай дауларды қарайды?',
        'about_a4_info': 'Төрелік азаматтық-құқықтық қатынастардан туындайтын дауларды жеке және (немесе) заңды тұлғалар арасындағы:',
        'about_a4_li1': 'мүліктік даулар;',
        'about_a4_li2': 'мүліктік қатынастарға байланысты жеке мүліктік емес қатынастардан туындайтын даулар.',
        'about_q5': 'Төрелікке бағынысты емес даулар:',
        'about_a5_li1': '1) кәмелетке толмаған адамдардың; 2) заңда белгіленген тәртіппен әрекетке қабілетсіз немесе әрекетке қабілеттілігі шектеулі деп танылған адамдар; 3) төрелік келісімге қатысушылар болып табылмайтын үшінші тұлғалардың;',
        'about_a5_li2': 'екінші деңгейдегі банктер арасындағы даулар;',
        'about_a5_li3': 'оңалту және банкроттық туралы;',
        'about_a5_li4': 'табиғи монополиялар субъектілері мен олардың тұтынушылары арасында;',
        'about_a5_li5': 'мемлекеттік органдар, квазимемлекеттік сектор субъектілері арасында;',
        'about_a5_li6': 'мүліктік қатынастарға байланысты емес жеке мүліктік емес қатынастардан туындайтын.',
        'about_q6': 'Дауды мемлекеттік сотпен салыстырғанда төрелікте қараудың артықшылықтары:',
        'about_a6_li1': 'дауласушы тараптар төрелік дауды қарауға тиіс ережелерді дербес айқындауға құқылы;',
        'about_a6_li2': 'тараптар талқылау орны мен тілін дербес таңдауға құқылы;',
        'about_a6_li3': 'тараптар төрешілерді дербес таңдауға құқылы;',
        'about_a6_li4': 'талқылаудың құпиялылығы;',
        'about_a6_li5': 'процестің жылдамдығы мен тиімділігі;',
        'about_a6_li6': 'төреліктің шешімі түпкілікті болып табылады, істің мәні бойынша қайта қарауға жатпайды;',
        'about_a6_li7': 'шетелдік төрелік шешімдерді тану және орындау туралы конвенцияның (Нью-Йорк қаласы, 1958 жылғы 10 маусым) болуының арқасында төрелік шешімді шет мемлекеттің аумағында орындау оңай.',
        'table1_title': 'Салыстыру',
        'th_comp': 'Салыстыру',
        'th_court': 'Сот',
        'th_arb': 'Төрелік',
        'td_term_title': 'істі қарау мерзімі',
        'td_term_court': '3 ай',
        'td_term_arb': '1 ай, ұзағанда 2 ай',
        'td_force_title': 'шешімнің заңды күшіне енуі',
        'td_force_court': 'түпкілікті нысанда дайындалғаннан кейін 1 айдан кейін',
        'td_force_arb': 'түпкілікті нысандағы шешім дайындалған күні',
        'td_cancel_title': 'шешімнің күшін жою үшін негіздер',
        'td_cancel_court': 'кез келген негіз бойынша',
        'td_cancel_arb': 'тек процессуалдық бұзушылықтар ғана, ал төреліктің шешімі мәні бойынша қайта қаралмайды',
        'td_terr_title': 'аумақтық соттылық',
        'td_terr_court': 'сот орналасқан белгілі бір аумақта ғана',
        'td_terr_arb': 'Қазақстанның бүкіл аумағы бойынша',
        'td_fee_title': 'мемлекеттік баж салығы және төрелік алым сомасы',
        'td_fee_court': '3%, ең көп дегенде 20 000 АЕК',
        'td_fee_arb': 'талап сомасы неғұрлым көп болса, мемлекеттік баж салығымен салыстырғанда төрелік алым соғұрлым аз, ең көбі 15 000 АЕК',
        'table2_title': 'Мемлекеттік баж салығымен төрелік алым мөлшерін салыстыру',
        'th2_1': 'Талап-арыздың мөлшері (тенге)',
        'th2_2': 'Баж салығы (тенге)',
        'th2_3': 'Төрелік алым (тенге)',
        'td2_last': '650 000 АЕК бастап және одан жоғары',
        ...
        'clause_text': 'Осы шарттан (келiсiмнен, келiсiм-шарттан) не соған байланысты туындаған барлық даулар, келiспеушiлiктер немесе талаптар тұрақты жұмыс iстейтiн төрелiкте - «Орта-Азия экономикалық төрелiгi» ЖШС оның Регламентiне сәйкес шешiлуге тиiс. Төреліктің құрамына бір төреші кіреді. Төрелік талқылау тілі - қазақ тілі.',
        'clause_info': 'Жасалған шартқа (келiсiмге, келiсiм-шартқа) төрелiк ескертпенi енгiзу үшiн оған жоғарыда көрсетiлген төрелiк ескертпенi көздейтiн қосымша келiсiм жасасу қажет.',
        ...
        'table2_title_full': 'Мемлекеттік баж салығымен төрелік алым мөлшерін салыстыру',
        'td_force_court': 'түпкілікті нысанда дайындалғаннан кейін 1 айдан кейін',
        'td_cancel_arb': 'тек процессуалдық бұзушылықтар ғана, ал төреліктің шешімі мәні бойынша қайта қаралмайды',
        'td_terr_court': 'сот орналасқан белгілі бір аумақта ғана',
        'td_fee_arb': 'талап сомасы неғұрлым көп болса, мемлекеттік баж салығымен салыстырғанда төрелік алым соғұрлым аз, ең көбі 15 000 АЕК',
